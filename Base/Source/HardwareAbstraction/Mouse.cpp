...
int CMouse::Read(const float deltaTime)
{
	...
	{
		if (thePlayerInfo->GetAnimState() == CPlayerInfo::PLR_ANIM_IDLE && thePlayerInfo->getMana() >= thePlayerInfo->getManaCost())
		{
	...
	{
		if (thePlayerInfo->GetAnimState() == CPlayerInfo::PLR_ANIM_RIGHTARM_CASTHOLDING && thePlayerInfo->getMana() >= thePlayerInfo->getManaCost())
		{
	...
	{
		if (thePlayerInfo->GetAnimState() == CPlayerInfo::PLR_ANIM_LEFTARM_CASTHOLDING && thePlayerInfo->getMana() >= thePlayerInfo->getManaCost())
		{
